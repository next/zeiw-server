...
function findOpenGame(user, socket: socketIO.Socket, opponentId) {
	let g = null
...
const Game = (() => {
	class Game {
		...
		secs: number
		id: string
		forcedOpponentId: any
		ball: any
		p1: any
		p2: any
		interval: number
		secint: NodeJS.Timeout
